...
namespace Tedd.MortonEncodingArchive.Baselines
{
    /// <summary>
    /// Software branches extracted from the published v1.0.1 implementation.
    /// They permit deterministic software-only measurements on BMI2 machines.
    /// </summary>
    public static class V1_0_1Software
    {
